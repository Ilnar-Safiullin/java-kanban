...
public class CSVTaskFormatTest {
    ...
    public void toStringTaskTest() {
        ...
        assertEquals("2,EPIC,Epic,NEW,Test,PT0S,3099-01-01T00:00", CSVTaskFormat.toString(epic),
    ...
    public void taskFromStringTest() {
        ...
        assertEquals(epic, CSVTaskFormat.taskFromString("2,EPIC,Epic,NEW,Test,PT0S,3099-01-01T00:00"),
