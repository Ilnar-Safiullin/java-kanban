...
// Перезалил файл ничего не трогал больше. Все комментарии которые ты оставлял я все исправил и методы обновления добавлены же.
// Может ты предыдущий файл нечайно открыл?
